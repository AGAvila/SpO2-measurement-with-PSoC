...
{
    uint8 staticBits = (UART_TX_DR & (uint8)(~UART_TX_MASK));
    UART_TX_DR = staticBits | ((uint8)(value << UART_TX_SHIFT) & UART_TX_MASK);
}
...
{
	CyPins_SetPinDriveMode(UART_TX_0, mode);
}
...
{
    return (UART_TX_PS & UART_TX_MASK) >> UART_TX_SHIFT;
}
...
{
    return (UART_TX_DR & UART_TX_MASK) >> UART_TX_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & UART_TX_0_INTR) != 0u) 
		{ 
			 UART_TX_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (UART_TX_INTSTAT & UART_TX_MASK) >> UART_TX_SHIFT;
    }
