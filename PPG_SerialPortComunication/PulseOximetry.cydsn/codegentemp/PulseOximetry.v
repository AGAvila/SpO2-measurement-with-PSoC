// ======================================================================
// PulseOximetry.v generated from TopDesign.cysch
// 05/09/2023 at 17:49
...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("03fadae8-3bb5-4ab3-9c37-778b049b9af6/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("03fadae8-3bb5-4ab3-9c37-778b049b9af6/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		...
		Out2_1
		 (.oe(tmpOE__Out2_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Out2_1_net[0:0]}),
		  .analog({Photodiode_Input}),
	...
	cy_psoc3_pins_v1_10
		#(.id("95580418-f40b-4ce5-b1eb-6a99ce603cc5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e9c530a6-7a3f-42b5-9f9a-184bfa4267bf"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Broadband_Photodiode (
        .connect({
            Net_1034,
            Net_1032
        })
    );
    defparam Broadband_Photodiode.comp_name = "PhotoDiode_v1_0";
    defparam Broadband_Photodiode.port_names = "A, K";
    defparam Broadband_Photodiode.width = 2;

    TIA_v2_0_2 TIA (
        .Iin(Photodiode_Input),
        .Vout(Net_42),
        .Vref(Net_354));
    ...
    cy_annotation_universal_v1_0 PowerSupply (
        .connect({
            Net_580
        })
    );
    defparam PowerSupply.comp_name = "Power_v1_0";
    defparam PowerSupply.port_names = "T1";
    defparam PowerSupply.width = 1;
    ...
    cy_annotation_universal_v1_0 IR (
        .connect({
            Net_1041,
            Net_729
        })
    );
    defparam IR.comp_name = "LED_v1_0";
    defparam IR.port_names = "A, K";
    defparam IR.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("746d9bd7-28d8-464a-9e2a-854ef4ea15ae"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d37120ac-de89-43ae-adbb-8a414caa3041"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
