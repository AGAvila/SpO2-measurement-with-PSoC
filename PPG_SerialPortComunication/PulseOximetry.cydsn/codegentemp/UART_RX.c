...
{
    uint8 staticBits = (UART_RX_DR & (uint8)(~UART_RX_MASK));
    UART_RX_DR = staticBits | ((uint8)(value << UART_RX_SHIFT) & UART_RX_MASK);
}
...
{
	CyPins_SetPinDriveMode(UART_RX_0, mode);
}
...
{
    return (UART_RX_PS & UART_RX_MASK) >> UART_RX_SHIFT;
}
...
{
    return (UART_RX_DR & UART_RX_MASK) >> UART_RX_SHIFT;
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & UART_RX_0_INTR) != 0u) 
		{ 
			 UART_RX_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (UART_RX_INTSTAT & UART_RX_MASK) >> UART_RX_SHIFT;
    }
